...
public class RichDateFormat extends Format {
     ...
     */
    public static RichDateFormat getInstance() {
     ...
     */
    public static RichDateFormat getInstance(String pattern) {
     ...
     * @throws IllegalArgumentException if pattern is invalid
     */
    public static RichDateFormat getInstance(String pattern, TimeZone timeZone) {
     ...
     * @throws IllegalArgumentException if pattern is invalid
     */
    public static RichDateFormat getInstance(String pattern, Locale locale) {
     ...
     *  or <code>null</code>
     */
    public static synchronized RichDateFormat getInstance(String pattern, TimeZone timeZone, Locale locale) {
        RichDateFormat emptyFormat = new RichDateFormat(pattern, timeZone, locale);
        RichDateFormat format = (RichDateFormat) cInstanceCache.get(emptyFormat);
        if (format == null) {
            format = emptyFormat;
     ...
     * @since 2.1
     */
    public static RichDateFormat getDateInstance(int style) {
     ...
     * @since 2.1
     */
    public static RichDateFormat getDateInstance(int style, Locale locale) {
     ...
     * @since 2.1
     */
    public static RichDateFormat getDateInstance(int style, TimeZone timeZone) {
     ...
     *  pattern defined
     */
    public static synchronized RichDateFormat getDateInstance(int style, TimeZone timeZone, Locale locale) {
        ...
        RichDateFormat format = (RichDateFormat) cDateInstanceCache.get(key);
        if (format == null) {
            try {
     ...
     * @since 2.1
     */
    public static RichDateFormat getTimeInstance(int style) {
     ...
     * @since 2.1
     */
    public static RichDateFormat getTimeInstance(int style, Locale locale) {
     ...
     * @since 2.1
     */
    public static RichDateFormat getTimeInstance(int style, TimeZone timeZone) {
     ...
     *  pattern defined
     */
    public static synchronized RichDateFormat getTimeInstance(int style, TimeZone timeZone, Locale locale) {
        Object key = new Integer(style);
        if (timeZone != null) {
            key = new Pair(key, timeZone);
        }
        ...
        RichDateFormat format = (RichDateFormat) cTimeInstanceCache.get(key);
        if (format == null) {
            if (locale == null) {
                locale = Locale.getDefault();
            }
     ...
     * @since 2.1
     */
    public static RichDateFormat getDateTimeInstance(
     ...
     *  pattern defined
     */
    public static synchronized RichDateFormat getDateTimeInstance(int dateStyle, int timeStyle, TimeZone timeZone,
                                                                  Locale locale) {
        ...
        RichDateFormat format = (RichDateFormat) cDateTimeInstanceCache.get(key);
        if (format == null) {
            try {
     ...
     *  <code>null</code>
     */
    protected RichDateFormat(String pattern, TimeZone timeZone, Locale locale) {
        super();
        if (pattern == null) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RichDateFormat == false) {
            return false;
        }
        RichDateFormat other = (RichDateFormat) obj;
        if (
     ...
     */
    protected interface NumberRule extends Rule {
        /**
