 ...
 * </ul>
 */
public class HttpPostDataFactory implements HttpDataFactory {
     ...
     */
    public HttpPostDataFactory() {
        useDisk = false;
        checkSize = true;
        minSize = MINSIZE;
    }

    public HttpPostDataFactory(Charset charset) {
        this();
     ...
     */
    public HttpPostDataFactory(boolean useDisk) {
        this.useDisk = useDisk;
        checkSize = false;
    }

    public HttpPostDataFactory(boolean useDisk, Charset charset) {
        this(useDisk);
        this.charset = charset;
    }
    /**
     ...
     */
    public HttpPostDataFactory(long minSize) {
        useDisk = false;
        checkSize = true;
        this.minSize = minSize;
    }

    public HttpPostDataFactory(long minSize, Charset charset) {
        this(minSize);
        this.charset = charset;
    }
    ...
    public Attribute createAttribute(HttpRequest request, String name)
        ...
        return createAttribute(request, name, "");
        //throw new UnsupportedOperationException("Doesn't support non text attributes");
        /*
        if (useDisk) {
    ...
    public FileUpload createFileUpload(HttpRequest request, String name, String filename,
                                       ...
                                       long size) {
        MemoryTransferFileUpload fileUpload = new MemoryTransferFileUpload(name, filename, contentType,
